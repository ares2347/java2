...
public class HomeController {
    ...
    public void navigateStudents(ActionEvent actionEvent) throws IOException {
        Parent p = FXMLLoader.load(getClass().getResource("students/studentsController.fxml"));
    ...
    public void navigateBooks(ActionEvent actionEvent) throws IOException {
        Parent p = FXMLLoader.load(getClass().getResource("books/booksController.fxml"));
